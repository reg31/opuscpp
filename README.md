...
- Encode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.402x to 1.804x).
- Decode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.036x to 1.483x).
...
| Encode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.402x to 1.804x). | Supports a documented subset of the full Opus CTL/API surface. |
| Decode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.036x to 1.483x). | A few high-rate decode points are close to parity and official Opus remains extremely mature. |
...
|---:|---:|---:|---:|---:|---:|---:|
| 16&nbsp;kbps | 1.598x | 1.483x | +0.0000 | -0.0185 | 16.5 kbps | 16.9 kbps |
| 24&nbsp;kbps | 1.722x | 1.139x | -0.0072 | +0.0411 | 24.5 kbps | 25.0 kbps |
| 32&nbsp;kbps | 1.733x | 1.121x | +0.0007 | +0.0351 | 32.5 kbps | 33.3 kbps |
| 48&nbsp;kbps | 1.544x | 1.100x | +0.0010 | +0.0131 | 48.5 kbps | 48.5 kbps |
| 64&nbsp;kbps | 1.577x | 1.066x | +0.0010 | +0.0057 | 64.6 kbps | 64.6 kbps |
| 96&nbsp;kbps | 1.804x | 1.045x | +0.0002 | +0.0015 | 96.4 kbps | 96.6 kbps |
| 128&nbsp;kbps | 1.557x | 1.042x | +0.0006 | +0.0022 | 128.4 kbps | 128.7 kbps |
| 192&nbsp;kbps | 1.433x | 1.045x | +0.0003 | -0.0001 | 192.4 kbps | 192.9 kbps |
| 256&nbsp;kbps | 1.402x | 1.036x | +0.0005 | -0.0005 | 256.4 kbps | 256.8 kbps |
