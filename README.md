...
- Complexity-10 encode ratios range from 0.36x to 1.19x versus official Opus: faster at 16 kbps, near parity at 24/32 kbps, and encoding that takes 2.3-2.8x as long at 48-256 kbps.
- Decode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates (1.24x to 1.90x).
...
- Host object: `323,128 B`; Android arm64 object: `326,384 B` (text + data + BSS).
...
| Faster decode in 9/9 measured bitrates (1.24x to 1.90x). | Results describe this machine and workload, not every platform or packet mix. |
...
|---:|---:|---:|---:|---:|---:|---:|
| 16&nbsp;kbps | 1.188x | 1.896x | +0.0006 | -0.0032 | 16.000 kbps | 17.065 kbps |
| 24&nbsp;kbps | 1.025x | 1.417x | +0.1931 | +0.0753 | 24.000 kbps | 25.220 kbps |
| 32&nbsp;kbps | 1.025x | 1.431x | +0.2572 | +0.0791 | 32.000 kbps | 33.613 kbps |
| 48&nbsp;kbps | 0.422x | 1.362x | +0.0568 | +0.0060 | 48.000 kbps | 48.560 kbps |
| 64&nbsp;kbps | 0.362x | 1.315x | -0.0014 | +0.0031 | 64.000 kbps | 64.613 kbps |
| 96&nbsp;kbps | 0.428x | 1.309x | +0.0870 | +0.0112 | 96.000 kbps | 96.697 kbps |
| 128&nbsp;kbps | 0.406x | 1.309x | +0.1632 | +0.0028 | 128.000 kbps | 128.759 kbps |
| 192&nbsp;kbps | 0.413x | 1.295x | +0.0707 | +0.0030 | 192.000 kbps | 192.900 kbps |
| 256&nbsp;kbps | 0.402x | 1.241x | +0.0381 | +0.0019 | 256.000 kbps | 256.736 kbps |
