...
source-embeddable, standards-compatible, and faster to decode in the tracked O2 benchmark against an official build using platform intrinsics. At complexity 10, encoding is within 0.93x-1.27x of official speed across the tracked bitrates.
...
- Complexity-10 encode ratios range from 0.93x to 1.27x versus official Opus: faster at 16/24/32/96/128/192 kbps, and near parity (0.93x-0.97x) at 48/64/256 kbps.
- Decode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates (1.23x to 1.87x).
...
| Reconstruction-based search improves some quality results at complexity 10. | Encoding at 48/64/256 kbps is 0.93x-0.97x of official Opus speed in the measured workload. |
| Faster decode in 9/9 measured bitrates (1.23x to 1.87x). | Results describe this machine and workload, not every platform or packet mix. |
...
|---:|---:|---:|---:|---:|---:|---:|
| 16&nbsp;kbps | 1.268x | 1.872x | +0.0006 | -0.0032 | 16.000 kbps | 17.065 kbps |
| 24&nbsp;kbps | 1.078x | 1.431x | +0.2606 | +0.0806 | 24.000 kbps | 25.220 kbps |
| 32&nbsp;kbps | 1.052x | 1.405x | +0.3289 | +0.0856 | 32.000 kbps | 33.613 kbps |
| 48&nbsp;kbps | 0.945x | 1.342x | +0.1150 | +0.0089 | 48.000 kbps | 48.560 kbps |
| 64&nbsp;kbps | 0.967x | 1.324x | +0.0214 | +0.0054 | 64.000 kbps | 64.613 kbps |
| 96&nbsp;kbps | 1.057x | 1.306x | +0.0949 | +0.0114 | 96.000 kbps | 96.697 kbps |
| 128&nbsp;kbps | 1.102x | 1.308x | +0.1878 | +0.0043 | 128.000 kbps | 128.759 kbps |
| 192&nbsp;kbps | 1.009x | 1.288x | +0.0756 | +0.0032 | 192.000 kbps | 192.900 kbps |
| 256&nbsp;kbps | 0.929x | 1.226x | +0.0403 | +0.0018 | 256.000 kbps | 256.736 kbps |
