...
- Host MinGW GCC `-O2` binary text in the current measured snapshot: `262,104 B` (`280,192 B` text+data+bss).
...
| Encode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.51x to 1.88x). | Supports a documented subset of the full Opus CTL/API surface. |
| Decode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.05x to 1.86x). | A few high-rate decode points are close to parity and official Opus remains extremely mature. |
...
|---:|---:|---:|---:|---:|---:|---:|
| 16&nbsp;kbps | 1.644x | 1.861x | +0.0007 | -0.0129 | 16.440 kbps | 16.895 kbps |
| 24&nbsp;kbps | 1.563x | 1.308x | -0.0056 | +0.0462 | 24.460 kbps | 25.009 kbps |
| 32&nbsp;kbps | 1.735x | 1.259x | +0.0018 | +0.0383 | 32.480 kbps | 33.301 kbps |
| 48&nbsp;kbps | 1.511x | 1.191x | +0.0010 | +0.0131 | 48.520 kbps | 48.514 kbps |
| 64&nbsp;kbps | 1.519x | 1.186x | +0.0010 | +0.0057 | 64.560 kbps | 64.555 kbps |
| 96&nbsp;kbps | 1.623x | 1.164x | +0.0005 | +0.0037 | 96.400 kbps | 96.626 kbps |
| 128&nbsp;kbps | 1.881x | 1.143x | -0.0001 | +0.0017 | 128.400 kbps | 128.700 kbps |
| 192&nbsp;kbps | 1.877x | 1.052x | -0.0002 | +0.0003 | 192.400 kbps | 192.853 kbps |
| 256&nbsp;kbps | 1.600x | 1.052x | -0.0003 | -0.0001 | 256.400 kbps | 256.846 kbps |
