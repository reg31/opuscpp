...
- Host MinGW GCC `-O2` binary text in the current measured snapshot: `262,592 B` (`280,680 B` text+data+bss).
...
| Encode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.52x to 1.95x). | Supports a documented subset of the full Opus CTL/API surface. |
...
|---:|---:|---:|---:|---:|---:|---:|
| 16&nbsp;kbps | 1.662x | 1.703x | +0.0033 | -0.0023 | 16.440 kbps | 16.895 kbps |
| 24&nbsp;kbps | 1.713x | 1.299x | +0.0041 | +0.0453 | 24.460 kbps | 25.009 kbps |
| 32&nbsp;kbps | 1.741x | 1.252x | +0.0018 | +0.0383 | 32.480 kbps | 33.301 kbps |
| 48&nbsp;kbps | 1.515x | 1.178x | +0.0010 | +0.0131 | 48.520 kbps | 48.514 kbps |
| 64&nbsp;kbps | 1.549x | 1.186x | +0.0010 | +0.0057 | 64.560 kbps | 64.555 kbps |
| 96&nbsp;kbps | 1.629x | 1.172x | +0.0005 | +0.0037 | 96.400 kbps | 96.626 kbps |
| 128&nbsp;kbps | 1.948x | 1.150x | +0.0011 | +0.0015 | 128.400 kbps | 128.700 kbps |
| 192&nbsp;kbps | 1.741x | 1.099x | +0.0007 | +0.0005 | 192.400 kbps | 192.853 kbps |
| 256&nbsp;kbps | 1.608x | 1.071x | +0.0008 | -0.0001 | 256.400 kbps | 256.846 kbps |
