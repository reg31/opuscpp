...
| Encode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.34x to 1.69x). | Supports a documented subset of the full Opus CTL/API surface. |
| Decode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.04x to 1.57x). | A few high-rate decode points are close to parity and official Opus remains extremely mature. |
...
|---:|---:|---:|---:|---:|---:|---:|
| 16&nbsp;kbps | 1.342x | 1.573x | +0.0004 | -0.0165 | 16.782 kbps | 16.895 kbps |
| 24&nbsp;kbps | 1.661x | 1.177x | -0.0071 | +0.0438 | 24.460 kbps | 25.009 kbps |
| 32&nbsp;kbps | 1.691x | 1.159x | +0.0018 | +0.0383 | 32.480 kbps | 33.301 kbps |
| 48&nbsp;kbps | 1.492x | 1.123x | +0.0010 | +0.0131 | 48.520 kbps | 48.514 kbps |
| 64&nbsp;kbps | 1.492x | 1.095x | +0.0010 | +0.0057 | 64.560 kbps | 64.555 kbps |
| 96&nbsp;kbps | 1.465x | 1.059x | +0.0005 | +0.0037 | 96.400 kbps | 96.626 kbps |
| 128&nbsp;kbps | 1.513x | 1.044x | +0.0006 | +0.0022 | 128.400 kbps | 128.700 kbps |
| 192&nbsp;kbps | 1.414x | 1.042x | +0.0003 | -0.0001 | 192.400 kbps | 192.853 kbps |
| 256&nbsp;kbps | 1.355x | 1.053x | +0.0005 | -0.0005 | 256.400 kbps | 256.846 kbps |
