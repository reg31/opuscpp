...
- Encode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.407x to 1.726x).
- Decode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.036x to 1.492x).
...
- Host MinGW GCC `-O2` binary text in the current measured snapshot: `264,296 B`.
...
| Encode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.407x to 1.726x). | Supports a documented subset of the full Opus CTL/API surface. |
| Decode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.036x to 1.492x). | A few high-rate decode points are close to parity and official Opus remains extremely mature. |
...
|---:|---:|---:|---:|---:|---:|---:|
| 16&nbsp;kbps | 1.625x | 1.492x | +0.0000 | -0.0185 | 16.5 kbps | 16.9 kbps |
| 24&nbsp;kbps | 1.726x | 1.138x | -0.0072 | +0.0411 | 24.5 kbps | 25.0 kbps |
| 32&nbsp;kbps | 1.721x | 1.115x | +0.0007 | +0.0351 | 32.5 kbps | 33.3 kbps |
| 48&nbsp;kbps | 1.515x | 1.089x | +0.0010 | +0.0131 | 48.5 kbps | 48.5 kbps |
| 64&nbsp;kbps | 1.565x | 1.072x | +0.0010 | +0.0057 | 64.6 kbps | 64.6 kbps |
| 96&nbsp;kbps | 1.610x | 1.036x | +0.0002 | +0.0015 | 96.4 kbps | 96.6 kbps |
| 128&nbsp;kbps | 1.573x | 1.036x | +0.0006 | +0.0022 | 128.4 kbps | 128.7 kbps |
| 192&nbsp;kbps | 1.448x | 1.043x | +0.0003 | -0.0001 | 192.4 kbps | 192.9 kbps |
| 256&nbsp;kbps | 1.407x | 1.037x | +0.0005 | -0.0005 | 256.4 kbps | 256.8 kbps |
