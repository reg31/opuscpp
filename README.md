...
- Host MinGW GCC `-O2` measured object image in the current snapshot: `424,200 B` total.
...
| Encode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.51x to 2.86x). | Supports a documented subset of the full Opus CTL/API surface. |
| Decode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.03x to 1.83x). | A few high-rate decode points are close to parity and official Opus remains extremely mature. |
...
|---:|---:|---:|---:|---:|---:|---:|
| 16&nbsp;kbps | 2.856x | 1.828x | +0.0050 | +0.0009 | 16.000 kbps | 16.895 kbps |
| 24&nbsp;kbps | 1.986x | 1.459x | +0.0045 | +0.0155 | 24.000 kbps | 25.009 kbps |
| 32&nbsp;kbps | 2.077x | 1.152x | +0.0127 | +0.0322 | 32.000 kbps | 33.301 kbps |
| 48&nbsp;kbps | 1.747x | 1.200x | +0.0008 | +0.0024 | 48.000 kbps | 48.514 kbps |
| 64&nbsp;kbps | 2.111x | 1.251x | +0.0011 | +0.0050 | 64.000 kbps | 64.555 kbps |
| 96&nbsp;kbps | 1.511x | 1.095x | +0.0020 | +0.0038 | 96.000 kbps | 96.626 kbps |
| 128&nbsp;kbps | 1.892x | 1.128x | +0.0026 | +0.0011 | 128.000 kbps | 128.700 kbps |
| 192&nbsp;kbps | 1.639x | 1.093x | +0.0023 | +0.0000 | 192.000 kbps | 192.853 kbps |
| 256&nbsp;kbps | 1.845x | 1.029x | +0.0008 | +0.0001 | 256.000 kbps | 256.846 kbps |
