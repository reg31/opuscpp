...
| Encode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.35x to 1.72x). | Supports a documented subset of the full Opus CTL/API surface. |
| Decode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.02x to 1.57x). | A few high-rate decode points are close to parity and official Opus remains extremely mature. |
...
|---:|---:|---:|---:|---:|---:|---:|
| 16&nbsp;kbps | 1.353x | 1.570x | +0.0004 | -0.0165 | 16.782 kbps | 16.895 kbps |
| 24&nbsp;kbps | 1.720x | 1.166x | -0.0071 | +0.0438 | 24.460 kbps | 25.009 kbps |
| 32&nbsp;kbps | 1.586x | 1.173x | +0.0018 | +0.0383 | 32.480 kbps | 33.301 kbps |
| 48&nbsp;kbps | 1.478x | 1.127x | +0.0010 | +0.0131 | 48.520 kbps | 48.514 kbps |
| 64&nbsp;kbps | 1.490x | 1.112x | +0.0010 | +0.0057 | 64.560 kbps | 64.555 kbps |
| 96&nbsp;kbps | 1.528x | 1.075x | +0.0005 | +0.0037 | 96.400 kbps | 96.626 kbps |
| 128&nbsp;kbps | 1.505x | 1.045x | +0.0006 | +0.0022 | 128.400 kbps | 128.700 kbps |
| 192&nbsp;kbps | 1.633x | 1.021x | +0.0003 | -0.0001 | 192.400 kbps | 192.853 kbps |
| 256&nbsp;kbps | 1.354x | 1.113x | +0.0005 | -0.0005 | 256.400 kbps | 256.846 kbps |
