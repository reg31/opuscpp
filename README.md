...
- Host MinGW GCC `-O2` measured object image in the current snapshot: `288,796 B` total.
...
| Encode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.77x to 2.48x). | Supports a documented subset of the full Opus CTL/API surface. |
| Decode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.19x to 1.83x). | Official Opus remains extremely mature and supports a broader feature surface. |
...
|---:|---:|---:|---:|---:|---:|---:|
| 16&nbsp;kbps | 2.481x | 1.834x | +0.0059 | +0.0024 | 16.000 kbps | 17.065 kbps |
| 24&nbsp;kbps | 1.900x | 1.374x | +0.0148 | +0.0332 | 24.000 kbps | 25.220 kbps |
| 32&nbsp;kbps | 1.871x | 1.320x | +0.0211 | +0.0404 | 32.000 kbps | 33.613 kbps |
| 48&nbsp;kbps | 1.806x | 1.298x | +0.0006 | +0.0142 | 48.000 kbps | 48.560 kbps |
| 64&nbsp;kbps | 1.795x | 1.284x | +0.0075 | +0.0055 | 64.000 kbps | 64.613 kbps |
| 96&nbsp;kbps | 1.896x | 1.269x | +0.0002 | +0.0035 | 96.000 kbps | 96.697 kbps |
| 128&nbsp;kbps | 2.065x | 1.260x | +0.0010 | +0.0015 | 128.000 kbps | 128.759 kbps |
| 192&nbsp;kbps | 1.866x | 1.256x | +0.0007 | +0.0005 | 192.000 kbps | 192.900 kbps |
| 256&nbsp;kbps | 1.771x | 1.192x | +0.0008 | +0.0001 | 256.000 kbps | 256.736 kbps |
...
ViSQOL-style deltas. Its current PCM16 path adds 0.6% to 8.4% end-to-end decode time across the
tracked ladder and decodes 60 seconds in 0.033 to 0.083 seconds on the measured system. It remains
