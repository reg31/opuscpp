...
- Host MinGW GCC `-O2` binary text in the current measured snapshot: `261,628 B` (`279,716 B` text+data+bss).
...
| Decode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.06x to 1.71x). | A few high-rate decode points are close to parity and official Opus remains extremely mature. |
...
|---:|---:|---:|---:|---:|---:|---:|
| 16&nbsp;kbps | 2.354x | 1.708x | +0.0039 | +0.0001 | 16.000 kbps | 16.895 kbps |
| 24&nbsp;kbps | 1.728x | 1.306x | +0.0051 | +0.0430 | 24.000 kbps | 25.009 kbps |
| 32&nbsp;kbps | 1.724x | 1.253x | +0.0013 | +0.0365 | 32.000 kbps | 33.301 kbps |
| 48&nbsp;kbps | 1.515x | 1.203x | +0.0012 | +0.0126 | 48.000 kbps | 48.514 kbps |
| 64&nbsp;kbps | 1.526x | 1.180x | +0.0007 | -0.0016 | 64.000 kbps | 64.555 kbps |
| 96&nbsp;kbps | 1.580x | 1.174x | +0.0004 | +0.0040 | 96.000 kbps | 96.626 kbps |
| 128&nbsp;kbps | 1.947x | 1.145x | +0.0010 | +0.0015 | 128.000 kbps | 128.700 kbps |
| 192&nbsp;kbps | 1.650x | 1.114x | +0.0007 | +0.0005 | 192.000 kbps | 192.853 kbps |
| 256&nbsp;kbps | 1.574x | 1.057x | +0.0008 | +0.0001 | 256.000 kbps | 256.846 kbps |
