...
- Host MinGW GCC `-O2` measured object image in the current snapshot: `294,868 B` total.
...
| Encode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.58x to 2.37x). | Supports a documented subset of the full Opus CTL/API surface. |
| Decode is faster than official Opus with x86 intrinsics in 9/9 measured bitrates in the current run (1.09x to 1.78x). | A few high-rate decode points are close to parity and official Opus remains extremely mature. |
...
current speed ratios and effective-bitrate columns come from the repository's 60-second stereo
synthetic benchmark using the portable O2 performance profile. Quality metrics are synthetic
...
|---:|---:|---:|---:|---:|---:|---:|
| 16&nbsp;kbps | 2.372x | 1.780x | +0.0050 | +0.0009 | 16.000 kbps | 16.462 kbps |
| 24&nbsp;kbps | 1.655x | 1.343x | +0.0049 | +0.0229 | 24.000 kbps | 24.476 kbps |
| 32&nbsp;kbps | 1.669x | 1.292x | +0.0129 | +0.0403 | 32.000 kbps | 32.512 kbps |
| 48&nbsp;kbps | 1.577x | 1.224x | +0.0014 | +0.0127 | 48.000 kbps | 48.402 kbps |
| 64&nbsp;kbps | 1.607x | 1.221x | +0.0013 | +0.0050 | 64.000 kbps | 64.402 kbps |
| 96&nbsp;kbps | 1.691x | 1.198x | +0.0022 | +0.0038 | 96.000 kbps | 96.404 kbps |
| 128&nbsp;kbps | 1.947x | 1.178x | +0.0028 | +0.0011 | 128.000 kbps | 128.405 kbps |
| 192&nbsp;kbps | 1.753x | 1.155x | +0.0025 | -0.0000 | 192.000 kbps | 192.416 kbps |
| 256&nbsp;kbps | 1.663x | 1.095x | +0.0010 | +0.0001 | 256.000 kbps | 256.436 kbps |
...
|---:|---:|---:|---:|---:|
| 16&nbsp;kbps | +0.0216 | +0.0031 | 16.000 kbps | 16.255 kbps |
| 24&nbsp;kbps | +0.0094 | +0.0007 | 24.000 kbps | 24.148 kbps |
| 32&nbsp;kbps | +0.0244 | +0.0016 | 32.000 kbps | 32.184 kbps |
| 48&nbsp;kbps | +0.0128 | +0.0023 | 48.000 kbps | 48.244 kbps |
| 64&nbsp;kbps | +0.0105 | +0.0011 | 64.000 kbps | 64.501 kbps |
